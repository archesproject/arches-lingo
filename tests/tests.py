...
class ViewTests(TestCase):
    ...
    def test_get_concept_trees(self):
        with self.assertNumQueries(9):
            ...
            # 7: languages
            # 8: resource_instance_lifecycle_state_id per resource instance
            # 9: resource_instance_lifecycle_state names lookup
        ...
        self.assertIn("resource_instance_lifecycle_state_name", scheme)
        self.assertIsNotNone(scheme["resource_instance_lifecycle_state_name"])
