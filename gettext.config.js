...
module.exports = {
  input: {
    path: "./arches_lingo/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_lingo/locale", // output path of all created files
    ...
    locales: ["en", "ar", "de", "el", "es", "fr", "pt", "zh"],
